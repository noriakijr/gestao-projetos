...
<div id="MENU">
  ...
  <form style="font-family:Arial, Helvetica, sans-serif">
	...
	<td colspan=3 align="center" fontcolor="#FF0000"><h1>Caixa de Saida</h1></td>
	
	<tr>
	<td width="140"><h2>ID</h2></td><td><h2>Mensagem</h2></td><td><h2>Data de Envio</h2></td>
	<%
		List<Mensagem> mensagens = (List<Mensagem>)request.getAttribute("listaMensagensDestinatario");
		for(Mensagem mensagem:mensagens){
			out.println("<tr><td width=140>" + mensagem.getReceptorID() + " </td><td>" + mensagem.getTexto() + "</td>");
